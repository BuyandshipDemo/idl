...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	...
	handlerType := (*greet.ItemService)(nil)
...
func getItemHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*greet.ItemServiceGetItemArgs)
	realResult := result.(*greet.ItemServiceGetItemResult)
	success, err := handler.(greet.ItemService).GetItem(ctx, realArg.Req)
	if err != nil {
		return err
	}
...
func newItemServiceGetItemArgs() interface{} {
	return greet.NewItemServiceGetItemArgs()
}

func newItemServiceGetItemResult() interface{} {
	return greet.NewItemServiceGetItemResult()
}
...
func (p *kClient) GetItem(ctx context.Context, req *greet.GetItemReq) (r *greet.GetItemResp, err error) {
	var _args greet.ItemServiceGetItemArgs
	_args.Req = req
	var _result greet.ItemServiceGetItemResult
